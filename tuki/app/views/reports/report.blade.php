		...
		<div class="row">				
			<div class="medium-12 columns form-report">
				<div class="input-group">
					...
					<select id="sel-report" class="select-primary input-group-field">
						<option value="01">REPORTE DE ACTIVIDADES</option>
						<option value="02">REPORTE DE AFILIACIONES Y VISITAS</option>
						<option value="03">REPORTE DE REDENCIONES</option>			
					</select>
				</div>						
			</div>
			<div class="small-12 medium-10 medium-centered large-10 large-centered columns form-report" style="float: right;">
				<form id="form-export">	
					<div class="row">
						...
						<div class="medium-3 large-3 columns">
							<div class="input-group">
								...
								<input type="text" style="font-size: 1.5rem;" class="input-group-field" placeholder="DD/MM/AAAA"  id="dp1">
							</div>
						...
						<div class="medium-3 large-3 columns end">
							<div class="input-group">
								<span class="input-group-label"><i class="fa fa-calendar"></i></span>
								<input type="text" style="font-size: 1.5rem;" class="input-group-field" placeholder="DD/MM/AAAA"  id="dp2">
							</div>
							<span class="form-error">
								<p style="font-size: 20px; line-height: 0;">Fecha requerida</p>	
							</span>								
