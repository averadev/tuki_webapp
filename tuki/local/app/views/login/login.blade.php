...
<div class="wrapper">
		...
		<div class="top-bar white-color">
			<div  class="small-5 small-centered medium-5 medium-centered large-5 large-centered columns" style="background-color: white;">
				<div class="row">
									...
									<div>
										<div class="tabs-content" data-tabs-content="example-tabs">
											...
											<div class="tabs-panel" id="panel2v">
											 	...
											 	<input class="input-blue" type="text" name="username" placeholder="Usuario" />
											 	<button class="small-12 medium-12 large-12 columns home button expand">Recuperar</button>
											</div>
										</div>
									</div>
								</div>
